                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post" action="{{ route('transaksi_laundry.update', $tl->id) }}" >
                                                                        @csrf
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <select class="form-select" id="pelanggan_id" name="pelanggan_id">
                                                                                ...
                                                                                @foreach ($pelanggan as $p)
                                                                                    <option value="{{ $p->id }}" {{ old('pelanggan_id', $tl->pelanggan_id) == $p->id ? 'selected' : '' }}>
                                                                                        {{ $p->pelanggan_id }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="jenis_laundry_id" class="form-label">Jenis Layanan</label>
                                                                            <select class="form-select" id="jenis_laundry_id" name="jenis_laundry_id">
                                                                                ...
                                                                                @foreach ($jenis_laundry as $jl)
                                                                                    <option value="{{ $jl->id }}" {{ old('jenis_laundry_id', $tl->jenis_laundry_id) == $jl->id ? 'selected' : '' }}>
                                                                                        {{ $jl->jenis_laundry_id }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" id="tarif" name="tarif" value="{{ old('tarif', $tl->tarif) }}" required readonly>
                                                                            <div class="text-danger">
                                                                                @error('tarif')
                                                                                    {{ $message }}
                                                                                @enderror
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" id="tanggal_selesai" name="tanggal_selesai" value="{{ old('tanggal_selesai', $tl->tanggal_selesai) }}" required readonly>
                                                                            <div class="text-danger">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input class="form-control @error('jumlah_kelo') is-invalid @enderror" type="text" id="jumlah_kelo" name="jumlah_kelo" value="{{ old('jumlah_kelo', $tl->jumlah_kelo) }}" oninput="sum()" required/>
                                                                                @error('jumlah_kelo')
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="number" class="form-control" id="total_bayar" name="total_bayar" value="{{ old('total_bayar', $tl->total_bayar) }}" required readonly>
                                                                            <div class="text-danger">
                                                                                @error('total bayar')
                                                                                    {{ $message }}
                                                                                @enderror
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <select name="status" class="select2 form-control">
                                                                                    <option value="1" {{ old('status', $tl->status) == 1 ? 'selected' : '' }}>Lunas</option>
                                                                                    <option value="0" {{ old('status', $tl->status) == 0 ? 'selected' : '' }}>Belum lunas</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                            ...
                            <form method="post" action="{{ route('transaksi_laundry.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="nama_pelanggan" name="nama_pelanggan">
                                        <option value="">Pilih Nama Pelanggan</option>
                                        @foreach ($pelanggan as $p)
                                            <option value="{{ $p->id }}" {{ old('nama_pelanggan') == $p->id ? 'selected' : '' }}>
                                                {{ $p->nama_pelanggan }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="jenis_laundry" name="jenis_laundry" onchange="jenis_layanan()">
                                        <option value="">Pilih Jenis Layanan Laundry</option>
                                        @foreach ($jenis_laundry as $jl)
                                            <option value="{{ $jl->id }}" {{ old('jenis_laundry') == $jl->id ? 'selected' : '' }}>
                                                {{ $jl->jenis_laundry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    <label for="tanggal_selesai" class="form-label">Tanggal Selesai</label>
                                    <input type="text" class="form-control" id="tanggal_selesai" name="tanggal_selesai" required readonly>
                                    <div class="text-danger">
                                        @error('tanggal_selesai')
                                            {{ $message }}
                                        @enderror
