                                    ...
                                    <td>
                                        <div class="hstack gap-3 flex-wrap">
                                            ...
                                            data-bs-target="#editPelanggan{{ $p->id }}" class="btn btn-label"><i
                                                ...
                                                <form id="delete-form-{{ $p->id }}" action="{{ route('data_pelanggan.destroy', $p->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post" action="{{ route('data_pelanggan.update', $p->id) }}" enctype="multipart/form-data">
                                                                        @csrf
